...
public class AnalyticsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView happy_points = (TextView) v.findViewById(R.id.happy_points);
        happy_points.setText("35");

        TextView avg_mood = (TextView) v.findViewById(R.id.avg_mood);
        avg_mood.setText("Positive");

        TextView avg_mood_feedback = (TextView) v.findViewById(R.id.avg_mood_feedback);
        avg_mood_feedback.setText("Great Job");
        return v;
    }
}